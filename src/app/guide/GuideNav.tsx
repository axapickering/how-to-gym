...
export default function GuideNav() {
    ...
    const sections = [
        ...
        ['Routine',<EventRepeatIcon/>,'/guide/routine'],
    ];
    ...
    return (
        <Box sx={{minWidth: '20vw', bgcolor: 'background.paper', position: 'absolute', left: '5vw', top:'15vh', borderRadius:'10px' }}>
